...
const config = {
  ...
  //BotName
  inviteLink:
    "https://discord.com/api/oauth2/authorize?client_id=995061833759195256&permissions=0&scope=bot",
  //BotInvite Link
  Features: [
    {
      name: "Moderation",
    ...
    },
    {
      name: "Music",
      description:
        "We Have the best music system with hight qualité",
  ...
  githubLink: "https://github.com/@shirox",
  twitterLink: "https://twitter.com/ShiroXBot",
  mediumLink: "https://medium.com/@ShiroXBot",
  facebookLink: "https://facebook.com/@ShiroXBot",
  discordLink: "https://discord.gg/9xj8ceMyUj",
  youtubeLink: "https://www.youtube.com/@ShiroXBot",
};
